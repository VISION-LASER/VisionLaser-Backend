...
const createPublic = async (req, res) => {
    try {
        ...
        let nom = req.body.lastName || req.body.Nom || '';
        let prenom = req.body.firstName || req.body.Prenom || '';
        ...
        // Si Email est null ou undefined, mettre une chaîne vide
        ...
        const data = {
            ...
            Email: email, // Chaîne vide si non fourni
